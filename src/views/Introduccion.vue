...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.align-items-start.bg-full-width.bg-azul.p-4(data-aos='fade-up').d-flex.align-items-center.flex-column.flex-md-row.mb-4
      ...
      .my-auto
        p.pe-xl-3.mb-0 Esta unidad busca brindar a los estudiantes un conjunto de herramientas conceptuales y prácticas para facilitar la transición organizacional hacia una cultura basada en datos, optimizar el rendimiento de los equipos analíticos y asegurar la sostenibilidad de las soluciones de inteligencia de negocios en diversos sectores productivos.
